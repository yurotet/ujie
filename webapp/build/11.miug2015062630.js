...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(71)(".regHeader{text-align:center}.cntContainer{font-size:16px;margin:40px}.miu-text-end{float:right}.miu-text-p{text-indent:25px}.cntContainer .miu-title{text-align:center;margin-bottom:20px}");
	var __vue_template__ = "<div class=\"regHeader\">\n\t\t<img src=\"logo.png\">\n\t</div>\n\n\t<div class=\"cntContainer\">\n\t\t<div class=\"miu-title\">\n\t\t\t<h4>关于蜜柚</h4>\n\t\t</div>\n\t\t<p class=\"miu-text-p\">MIU TOUR蜜柚旅行创立于2014年，旨在让用户真正享受轻松自在、趣味非凡的海外私人旅行！MIU TOUR致力于在游客与境外终端导游之间建立直接对接的P2P平台，让用户享受到定制化深度旅游的同时，节省大量的时间、精力和成本；也为有能力的终端导游创造了可以实现差异化服务的空间，从而提供更具当地特色的景点线路和旅游项目提供给用户。MIU TOUR，寻觅最诱人的海外本地旅行！</p>\t\t\t\t\t\t\n\t</div>";
