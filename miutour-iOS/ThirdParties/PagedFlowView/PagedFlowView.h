...
//    id       pageControl; //可以是自己自定义的PageControl
...
@property(nonatomic,assign)IBOutlet id <PagedFlowViewDataSource> dataSource;
@property(nonatomic,assign)IBOutlet id <PagedFlowViewDelegate>   delegate;
@property(nonatomic,strong)    id       pageControl;
