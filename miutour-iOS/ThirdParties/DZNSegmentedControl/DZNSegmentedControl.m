...
- (void)didMoveToWindow
{
    if (!self.backgroundColor) {
        self.backgroundColor = [UIColor colorWithBackgroundColorMark:(NSInteger)];
    }
...
- (CGRect)selectionIndicatorRect
{
    ...
    if (self.autoAdjustSelectionIndicatorWidth) {
        ...
        frame.size = CGSizeMake([title sizeWithAttributes:attributes].width + 10, self.selectionIndicatorHeight);
