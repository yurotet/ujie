...
#define _IMAGE_UNDER       [UIImage ImageWithNameFromTheme:@"black_bg_ip5.png"]
#define _IMAGE_MIC_NORMAL  [UIImage ImageWithNameFromTheme:@"mic_normal_358x358.png"]
#define _IMAGE_MIC_TALKING [UIImage ImageWithNameFromTheme:@"mic_talk_358x358.png"]
#define _IMAGE_MIC_WAVE [UIImage ImageWithNameFromTheme:@"wave70x117.png"]
