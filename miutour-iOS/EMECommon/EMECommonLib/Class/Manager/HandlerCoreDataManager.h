...
#define CoreDataName @"EMEDB";

/*!
 *@class HandlerCoreDataManager
 *@super NSObject
 *@abstract coreDate数据操作单例
 */

@interface HandlerCoreDataManager : NSObject
 ...
 *  @param sqliteName   sqliteName 可选，如果为nil 则默认设置为coreDataModeName  EMEApp 自动生成 EMEApp.sqlite3
 */
