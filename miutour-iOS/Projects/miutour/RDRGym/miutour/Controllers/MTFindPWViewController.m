...
@interface MTFindPWViewController()

@property (nonatomic,assign)BOOL naviHidden;

@end

@implementation MTFindPWViewController
...
@implementation MTFindCommandDelegate

/* To override the methods, uncomment the line in the init function(s)
 in MTFindPWViewController.m
 */
...
@implementation MTFindCommandQueue
