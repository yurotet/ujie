...
@interface MTSpliceTableViewCell()
...
@implementation MTSpliceTableViewCell
...
- (UILabel *)stableNumberLabel
{
    if (_stableNumberLabel == nil) {
        _stableNumberLabel = [[UILabel alloc] initWithFrame:CGRectMake(115*[ThemeManager themeScreenWidthRate], 136, 91, 16)];
        _stableNumberLabel.textAlignment = NSTextAlignmentCenter;
        _stableNumberLabel.font = [UIFont fontWithFontMark:4];
        _stableNumberLabel.text = @"客人组数";
        _stableNumberLabel.textColor = [UIColor colorWithTextColorMark:2];
    }
    return _stableNumberLabel;
}
...
-(void)initView
{
    ...
    [self.contentView addSubview:self.stableNumberLabel];
...
-(void)efSetCellWithData:(MTSpliceModel *)data
{
    ...
    self.numberLabel.text = [NSString stringWithFormat:@"%@组",data.nums];
