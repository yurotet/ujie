...
@implementation MTTakenBlockTableViewCell
...
//        UIImageView *hurryImageView = [[UIImageView alloc] initWithFrame:(CGRect){CGPointMake(-2, -1.5),hurryImage.size}];
//        hurryImageView.image = hurryImage;
//        [_bgImageView addSubview:hurryImageView];
        
//        UIImage *rewardImage = [UIImage imageNamed:@"reward"];
//        UIImageView *rewardImageView = [[UIImageView alloc] initWithFrame:(CGRect){CGPointMake(self.frame.size.width-60, -1.5),rewardImage.size}];
//        rewardImageView.image = rewardImage;
//        [_bgImageView addSubview:rewardImageView];
