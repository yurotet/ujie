...
const static CGFloat kMTAlertViewDefaultButtonHeight       = 50;
const static CGFloat kMTAlertViewDefaultButtonSpacerHeight = 1;
const static CGFloat kMTAlertViewCornerRadius              = 7;
...
- (IBAction)customIOS7dialogButtonTouchUpInside:(id)sender
{
    ...
    if (delegate != NULL) {
        [delegate customIOS7dialogButtonTouchUpInside:self clickedButtonAtIndex:[btn tag]];
    }
...
- (UIView *)createContainerView
{
    ...
    CGFloat cornerRadius = kMTAlertViewCornerRadius;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton.layer setCornerRadius:kMTAlertViewCornerRadius];
...
- (CGSize)countScreenSize
{
    if (buttonTitles!=NULL && [buttonTitles count] > 0) {
        buttonHeight       = kMTAlertViewDefaultButtonHeight;
        buttonSpacerHeight = kMTAlertViewDefaultButtonSpacerHeight;
    } else {
        buttonHeight = 0;
