//
//  MTGroupBaseInfoTableViewCell.m
//  miutour
//
...
@interface MTGroupBaseInfoTableViewCell()
...
@implementation MTGroupBaseInfoTableViewCell
...
{
    if (_bgImageView == nil) {
        _bgImageView = [[UIImageView alloc] initWithFrame:CGRectMake(9, 15, self.frame.size.width - 18, 166)];
...
- (UILabel *)carTypeLabel
{
    if (_carTypeLabel == nil) {
        _carTypeLabel = [[UILabel alloc] initWithFrame:CGRectMake(14, 80, 300, 25)];
