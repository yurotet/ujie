...
#import "MTSpliceGroupTableViewCell.h"
#import "AttributedLabel.h"

@interface MTSpliceGroupTableViewCell()
...
@implementation MTSpliceGroupTableViewCell
...
- (UILabel *)realPickLocLabel
{
    if (_realPickLocLabel == nil) {
        ...
        _realPickLocLabel.text = @"2015-0101 0101(当地时间)";
