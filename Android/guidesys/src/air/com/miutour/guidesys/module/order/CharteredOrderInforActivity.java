...
public class CharteredOrderInforActivity extends BaseFragmentActivity {
    private static final String TAG = "CharteredOrderInforActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_infor_chartered);
    ...
    private void initView() {
        ...
        destinationTv = (TextView) findViewById(R.id.location_tv);
    ...
    private void loadData() {
        ...
        OrderSever.loadInforData(CharteredOrderInforActivity.this, orderId, TAG, new HttpListener() {
    ...
    private void setData(JSONObject jsonObject) {
        ...
        destinationTv.setText(baseInfor.destination);
